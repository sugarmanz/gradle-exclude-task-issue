...
class AggregateExtension {
    ...
    AggregateExtension(Project project, Map<String, Object> attributes) {
        this.attributes = attributes
        this.project = project
        ExpandoMetaClass mc = new ExpandoMetaClass(AggregateExtension, false, true)
        mc.initialize()
        metaClass = mc
    }
